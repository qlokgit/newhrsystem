                ...
                <?php if(Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet')): ?>
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item">
                                    <a class="dash-link"
                                        href="<?php echo e(route('shift.index')); ?>"><?php echo e(__('Shift Roster')); ?></a>
                                </li>
...
<?php /**PATH D:\joki\codecanyon-iMuwzIOg-hrmgo-saas-hrm-and-payroll-tool\New Project\updat1_main_file\main_file\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>