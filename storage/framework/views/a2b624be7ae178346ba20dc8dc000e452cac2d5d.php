    ...
    <div class="modal-body" id="">
        <div class="row">
            ...
            <div class="form-control" >
                ...
                <input type="hidden" <?php if(Auth::user()->type == 'company'): ?>name="company_signature" <?php elseif(Auth::user()->type == 'employee' ): ?> name="employee_signature" <?php endif; ?> id="SignupImage1">
            </div>
            <div class="mt-1">
