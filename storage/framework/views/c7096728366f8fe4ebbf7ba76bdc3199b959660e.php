    ...
    <div class="row align-items-center m-1">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Contract Type')): ?>
            <div class="col-auto pe-0">
                <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Create Contract')); ?>" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Create Contract')); ?>" data-url="<?php echo e(route('contract_type.create')); ?>"><i class="ti ti-plus text-white"></i></a>
            </div>
        <?php endif; ?>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\joki\codecanyon-iMuwzIOg-hrmgo-saas-hrm-and-payroll-tool\New Project\updat1_main_file\main_file\resources\views/contract_type/index.blade.php ENDPATH**/ ?>