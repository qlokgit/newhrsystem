        ...
        <div class="row">
            <div class="col-12">
                <table class="table" id="pc-dt-simple">
                    ...
                    <?php if($hr->rejected_by): ?>
                        <tr>
                            <th><?php echo e(__('Rejected By')); ?></th>
                            <td><?php echo e($hr->rejectedBy->name); ?></td>
                        </tr>
                    <?php endif; ?>
    ...
    <?php if(\Auth::user()->type == 'hr' || \Auth::user()->type == 'company'): ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
    <?php echo e(Form::close()); ?><?php /**PATH D:\joki\jokiweb\hrsystem\main_file_2\main_file\resources\views/leave/action.blade.php ENDPATH**/ ?>