...
<?php echo e(Form::model($employeeShift, ['route' => ['employee_shift.update', $employeeShift->id], 'method' => 'PUT'])); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="form-color-user">
                    <?php echo e(Form::color('color', null, ['class' => 'form-control', 'placeholder' => __('Enter color')])); ?>
            ...
            <div class="row col-12">
                <div class="form-group col-6">
                    ...
                    <div class="form-time_start-user">
                        <?php echo e(Form::time('time_start', null, ['class' => 'form-control', 'placeholder' => __('Enter Time Start')])); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group col-6">
                    ...
                    <div class="form-time_end-user">
                        <?php echo e(Form::time('time_end', null, ['class' => 'form-control', 'placeholder' => __('Enter Time End')])); ?>
...
<?php /**PATH D:\joki\codecanyon-iMuwzIOg-hrmgo-saas-hrm-and-payroll-tool\New Project\updat1_main_file\main_file\resources\views/employee_shift/edit.blade.php ENDPATH**/ ?>