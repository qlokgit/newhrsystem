...
<?php echo e(Form::model($ZoomMeeting, ['route' => ['zoom-meeting.update', $ZoomMeeting->id], 'method' => 'PUT'])); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::text('start_date', null, array('class' => 'form-control d_week','required'=>'required'))); ?>
