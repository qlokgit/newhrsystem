    ...
    <div class="row align-items-center m-1">
        ...
        <div class="row mx-1">
            ...
            <div class="col-auto p-0 w-auto ">
                <a href="<?php echo e(route('send.mail.contract',$contract->id)); ?>" class="btn btn-sm btn-primary btn-icon"  data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Send Email')); ?>"  >
           ...
           <?php if((\Auth::user()->type == 'company')&&($contract->status=='Start')): ?>
            ...
            <div class="col-auto pe-0">
                <a href="#" data-size="lg" data-url="<?php echo e(route('contracts.copy',$contract->id)); ?>"data-ajax-popup="true" data-title="<?php echo e(__('Duplicate')); ?>" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Duplicate')); ?>" ><i class="ti ti-copy text-white"></i></a>
            </div>
            <?php endif; ?>
            ...
            <div class="col-auto pe-0">
                <a href="<?php echo e(route('get.contract',$contract->id)); ?>" target="_blank" class="btn btn-sm btn-primary btn-icon" title="<?php echo e(__('Preview')); ?>" data-bs-toggle="tooltip" data-bs-placement="top">
                    <i class="ti ti-eye"></i>
                </a>
            </div>
            <?php endif; ?>
            ...
            <?php if(((\Auth::user()->type =='company') && ($contract->company_signature == '')||(\Auth::user()->type =='employee') && ($contract->employee_signature == ''))&&($contract->status=='Start')): ?>
                <div class="col-auto pe-0">
                    <a href="#" class="btn btn-sm btn-primary btn-icon" data-url="<?php echo e(route('signature',$contract->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Signature')); ?>" data-size="md" title="<?php echo e(__('Signature')); ?>" data-bs-toggle="tooltip" data-bs-placement="top">
                                    ...
                                    <div class="card-body pt-0" style="margin-bottom: -30px; margin-top: -10px;">
                                        <address class="mb-0 text-sm">
                                            <dl class="row mt-4 align-items-center">
                                                ...
                                                <dt class="col-sm-4 h6 text-sm"><?php echo e(__('Employee Name')); ?></dt>
                                                <dd class="col-sm-8 text-sm"> <?php echo e($contract->employee->name); ?></dd>
                                    ...
                                    <div class=" py-3">
                                        ...
                                        <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto actions">
                                                        <?php if(((\Auth::user()->id == $file->user_id) || (\Auth::user()->type == 'company'))&&($contract->status == 'Start')): ?>
                                                            ...
                                                            <div class="list-group-item ">
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        ...
                                                                        <a href="<?php echo e(!empty($contract->employee->avatar) ? asset(Storage::url('uploads/avatar')) . '/' . $contract->employee->avatar : asset(Storage::url('uploads/avatar')) . '/avatar.png'); ?>" target="_blank">
                                                                        <img class="rounded-circle"  width="50" height="50" src="<?php echo e(!empty($contract->employee->avatar) ? asset(Storage::url('uploads/avatar')) . '/' . $contract->employee->avatar : asset(Storage::url('uploads/avatar')) . '/avatar.png'); ?>">
                                                                        </a>
                                                                    </div>
                                                                    <div class="col ml-n2">
                                                                    ...
                                                                    <?php if(((\Auth::user()->id == $comment->user_id) || (\Auth::user()->type == 'company')) &&($contract->status == 'Start')): ?>
                                                                                <div class="col-auto">
                                                                                    <form action=""></form>
                                                                                    <?php echo Form::open(['method' => 'GET', 'route' => ['comment.destroy', $comment->id]]); ?>

                                                                                        <a href="#!" class="mx-3 btn btn-sm d-inline-flex align-items-center bs-pass-para btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Delete')); ?>">
                                            ...
                                            <div class="list-group list-group-flush mb-0" id="comments">
                                                ...
                                                <div class="list-group-item ">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <?php if(((\Auth::user()->id == $note->user_id) || (\Auth::user()->type == 'company'))&&($contract->status == 'Start')): ?>
                                                                    <div class="col-auto">
