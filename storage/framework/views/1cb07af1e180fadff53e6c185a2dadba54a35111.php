                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-icon-user">
                            <?php echo e(Form::select('branch_id', $branches, !empty($jobOnBoard->applications) ? (!empty($jobOnBoard->applications->jobs) ? $jobOnBoard->applications->jobs->branch : '') : '', ['class' => 'form-control  select2', 'required' => 'required'])); ?>
