...
<?php echo e(Form::open(['route' => ['holidays.import'], 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12 mb-6">
            ...
            <a href="<?php echo e(asset(Storage::url('uploads/sample')) . '/sample_holidays.csv'); ?>"
