                                ...
                                <ul class="nav nav-pills mb-3" id="myTab3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#salary"
                                            role="tab" aria-controls="" aria-selected="true"><?php echo e(__('Salary')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#allowance"
                                            role="tab" aria-controls="" aria-selected="false"><?php echo e(__('Allowance')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#commission"
                                            role="tab" aria-controls="" aria-selected="false"><?php echo e(__('Commission')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#loan"
                                            role="tab" aria-controls="" aria-selected="false"><?php echo e(__('Loan')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab4" data-toggle="tab"
                                            href="#saturation-deduction" role="tab" aria-controls=""
                                            aria-selected="false"><?php echo e(__('Saturation Deduction')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#other-payment"
                                            role="tab" aria-controls="" aria-selected="false"><?php echo e(__('Other Payment')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#overtime"
                                            role="tab" aria-controls="" aria-selected="false"><?php echo e(__('Overtime')); ?></a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('allowance_option', $allowance_options, null, ['class' => 'form-control ','required' => 'required'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::number('amount', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
                                                ...
                                                <table class="table table-striped mb-0" id="allowance-dataTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-right" width="200px"><?php echo e(__('Action')); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('loan_option', $loan_options, null, ['class' => 'form-control ', 'required' => 'required'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('start_date', null, ['class' => 'form-control ','id' => 'data_picker4','required' => 'required'])); ?>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('end_date', null, ['class' => 'form-control ', 'id' => 'data_picker3', 'required' => 'required'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::textarea('reason', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('deduction_option', $deduction_options, null, ['class' => 'form-control ','required' => 'required'])); ?>
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $saturationdeductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saturationdeduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($saturationdeduction->deduction_option()->name); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::number('number_of_days', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::number('rate', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
