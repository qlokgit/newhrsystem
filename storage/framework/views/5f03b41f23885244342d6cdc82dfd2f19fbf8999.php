...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            <?php echo e(Form::text('purpose_of_visit', null, ['class' => 'form-control' ])); ?>

        </div>
        <div class="form-group col-lg-6 col-md-6">
            <?php echo e(Form::label('place_of_visit', __('Country'), ['class' => 'col-form-label'])); ?>

            <?php echo e(Form::text('place_of_visit', null, ['class' => 'form-control'])); ?>
