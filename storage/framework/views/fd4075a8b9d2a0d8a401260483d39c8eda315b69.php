                                            ...
                                            <?php if($leave->status == 'Pending'): ?>
                                                <div class="action-btn bg-success ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                        ...
                                                        data-bs-target="#approveModal<?php echo e($leave->id); ?>">
                                                        <i class="ti ti-caret-right text-white"></i>
                                                    </a>
                                                </div>
                                                <!-- Modal -->
                                                <div class="modal fade" id="approveModal<?php echo e($leave->id); ?>" tabindex="-1"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\joki\codecanyon-iMuwzIOg-hrmgo-saas-hrm-and-payroll-tool\New Project\updat1_main_file\main_file\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>