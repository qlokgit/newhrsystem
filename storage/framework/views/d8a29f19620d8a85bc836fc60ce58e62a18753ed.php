<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('employee_shift.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('employee_shift*') ? 'active' : ''); ?>"><?php echo e(__('Employee Shift')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
<?php /**PATH D:\joki\codecanyon-iMuwzIOg-hrmgo-saas-hrm-and-payroll-tool\New Project\updat1_main_file\main_file\resources\views/layouts/hrm_setup.blade.php ENDPATH**/ ?>