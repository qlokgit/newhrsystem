{{ Form::open(['url' => 'employee_shift', 'method' => 'post']) }}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="form-color-user">
                    {{ Form::color('color', '', ['class' => 'form-control', 'placeholder' => __('Enter color')]) }}
                </div>
                @error('color')
                    <span class="invalid-name" role="alert">
                        <strong class="text-danger">{{ $message }}</strong>
            ...
            <div class="row col-12">
                <div class="form-group col-6">
                    ...
                    <div class="form-time_start-user">
                        {{ Form::time('time_start', '', ['class' => 'form-control', 'placeholder' => __('Enter Time Start')]) }}
                    </div>
                    @error('time_start')
                        <span class="invalid-name" role="alert">
                            <strong class="text-danger">{{ $message }}</strong>
                ...
                <div class="form-group col-6">
                    ...
                    <div class="form-time_end-user">
                        {{ Form::time('time_end', '', ['class' => 'form-control', 'placeholder' => __('Enter Time End')]) }}
                    </div>
                    @error('time_end')
                        <span class="invalid-name" role="alert">
                            <strong class="text-danger">{{ $message }}</strong>
