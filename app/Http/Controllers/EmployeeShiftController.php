    ...
    public function update(Request $request, EmployeeShift $employeeShift)
    {
        if (\Auth::user()) {
            if ($employeeShift->created_by == \Auth::user()->creatorId()) {
                ...
                $employeeShift->time_start = $request->time_start;
                $employeeShift->time_end = $request->time_end;
                $employeeShift->color = $request->color;
                $employeeShift->initial = $request->initial;
                $employeeShift->save();
